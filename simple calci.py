...
w = Tk()  # This is to create a basic window
w.geometry("312x324")  # this is for the size of the window
w.resizable(0, 0)  # this is to prevent from resizing the window
w.title("Calculator")
...
input_frame = Frame(w, width=312, height=50, bd=0, highlightbackground="black", highlightcolor="black",
